module.exports = [
"[project]/node_modules/dhtmlx-gantt/codebase/dhtmlxgantt.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const rn = Object.freeze(Object.defineProperty({
    ...
    value: "Module"
})), Z = "undefined" < "u" ? window : /*TURBOPACK member replacement*/ __turbopack_context__.g;
let Nn = class {
    constructor(t){
...
xe.prototype = {
    ...
    _renderGridHeader: function() {
        ...
        for(var d = 0; d < a.length; d++){
            ...
            var y = t._sort && h.name == t._sort.name ? `<div data-column-id="${h.name}" class="gantt_sort gantt_${t._sort.direction}"></div>` : "", k = [
...
var ue, he;
"undefined" < "u" && window.jQuery && (ue = window.jQuery, he = [], ue.fn.dhx_gantt = function(t) {
...
"undefined" < "u" && window.dhtmlx && (window.dhtmlx.attaches || (window.dhtmlx.attaches = {}), window.dhtmlx.attaches.attachGantt = function(t, e, n) {
    var i = document.createElement("DIV");
...
}), "undefined" < "u" && window.dhtmlXCellObject !== void 0 && (window.dhtmlXCellObject.prototype.attachGantt = function(t, e, n) {
    n = n || window.gantt;
    var i = document.createElement("DIV");
...
//# sourceMappingURL=node_modules_dhtmlx-gantt_codebase_dhtmlxgantt_es_1f0d5f6f.js.map