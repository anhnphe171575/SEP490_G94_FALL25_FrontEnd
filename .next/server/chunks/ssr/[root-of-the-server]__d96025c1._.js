...
"[project]/src/app/projects/new/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NewProjectPage() {
    ...
    const onSubmit = async (e)=>{
        ...
        try {
            setSubmitting(true);
            setError(null);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$ultis$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/projects', {
                topic,
                code
            });
            if (res.status === 201) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d96025c1._.js.map