...
;
;
function GanttChart({ milestones, viewMode, startDate, autoFit = true, pagingStepDays, onRequestShift, columnWidth = 160, enableDrag = true, enableWheelPan = true, enableEdgePaging = true, stickyScrollbar = true, statusColors, onMilestoneShift }) {
    _s();
    ...
    const barDragStartXRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const [barDragState, setBarDragState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const getISOWeek = (d)=>{
        ...
        const dayNum = date.getUTCDay() || 7; // ISO: Monday=1, Sunday=7
        date.setUTCDate(date.getUTCDate() + 4 - dayNum);
        const yearStart = new Date(Date.UTC(date.getUTCFullYear(), 0, 1));
        const weekNo = Math.ceil(((date.getTime() - yearStart.getTime()) / 86400000 + 1) / 7);
        return weekNo;
    };
    const weekHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GanttChart.useMemo[weekHeader]": ()=>{
            const weekStart = days[0];
            const weekEnd = days[Math.min(days.length - 1, 6)];
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: `Week ${weekHeader.isoWeek}`
                            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                onPointerDown: (e)=>{
                    ...
                    // If we're dragging a milestone bar, the bar's handler will set capture and stop propagation.
                ...
                onPointerMove: (e)=>{
                    ...
                    const b = bottomScrollRef.current;
                    if (!c) return;
                    // Handle bar drag if active
                    if (barDragState) {
                        const dx = e.clientX - barDragStartXRef.current;
                        const deltaDays = Math.round(dx / columnWidth);
                        if (deltaDays !== barDragState.delta) {
                            setBarDragState({
                                id: barDragState.id,
                                delta: deltaDays
                            });
                ...
                onPointerUp: (e)=>{
                    ...
                    const c = containerRef.current;
                    if (!c) return;
                    // Commit bar drag if active
                    if (barDragState) {
                        const delta = barDragState.delta || 0;
                        if (delta !== 0 && !isQuarters) {
                            onMilestoneShift?.(barDragState.id, delta);
                        }
                        setBarDragState(null);
                        // Do not treat as a pan end
                        return;
                    }
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: milestones.map((m)=>{
                                ...
                                const dateLabel = [
                                    m.start_date,
                                    m.deadline
                                ].filter(Boolean).map((d)=>new Date(d).toLocaleDateString("en-US")).join(" → ");
                                const isActive = !!barDragState && barDragState.id === m._id;
                                const dragStyle = isActive && !isQuarters ? {
                                    transform: `translateX(${barDragState.delta * columnWidth}px)`
                                } : {};
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    onPointerDown: (e)=>{
                                        if (!enableDrag || isQuarters) return;
                                        e.stopPropagation();
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: `h-8 w-full rounded-md text-sm px-3 flex items-center justify-between gap-2 ${color} shadow-sm hover:shadow-md transition-shadow cursor-grab`,
                                        style: {
                                            overflow: "hidden"
                                        },
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(GanttChart, "idgJPzufVjEtIpD3PX5Wh+hibH8=");
_c = GanttChart;
...
_s1(Timeline, "c5Ow/7VQaHVcCN3qxr6V4MPycLY=");
_c1 = Timeline;
var _c, _c1;
...
//# sourceMappingURL=_bbbbb61c._.js.map