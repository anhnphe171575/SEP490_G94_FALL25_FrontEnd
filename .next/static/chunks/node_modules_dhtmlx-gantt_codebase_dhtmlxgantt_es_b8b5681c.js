...
"[project]/node_modules/dhtmlx-gantt/codebase/dhtmlxgantt.es.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Lt(t) {
    for(var e = t.querySelectorAll([
        ...
        "[tabindex]",
        "[contenteditable]"
    ].join(", ")), n = Array.prototype.slice.call(e, 0), i = 0; i < n.length; i++)n[i].$position = i;
...
function rt(t, e) {
    var s;
    var _ref;
    const n = document.documentElement, i = V(e), { clientX: a, clientY: r } = (_ref = (s = t.touches) == null ? void 0 : s[0]) !== null && _ref !== void 0 ? _ref : t;
    return {
...
const rn = Object.freeze(Object.defineProperty({
    ...
    value: "Module"
})), Z = typeof window < "u" ? window : /*TURBOPACK member replacement*/ __turbopack_context__.g;
let Nn = class {
    attach(t, e, n) {
...
function ot(t) {
    ...
    t.attachEvent = function(n, i, a) {
        ...
        return r.ev_listen_all && r.ev_listen_all.apply(this, [
            n
        ].concat(i)), !r[a] || r[a].apply(this, i);
...
class Pn {
    ...
    setStart(e) {
        const n = this._gantt;
        this._startPoint = e, this._startDate = n.dateFromPos(this._startPoint.relative.left), this._viewPort.callEvent("onBeforeDrag", [
            this._startPoint
        ]);
    }
    setEnd(e) {
        ...
        }), this._viewPort.callEvent("onDrag", [
            this._startPoint,
            this._endPoint
        ]);
    }
    ...
    dragEnd(e) {
        const n = this._gantt;
        e.relative.left < 0 && (e.relative.left = 0), this._viewPort.callEvent("onBeforeDragEnd", [
            this._startPoint,
            e
        ]), this.setEnd(e), this._endDate = this._endDate || n.getState().max_date, this._startDate.valueOf() > this._endDate.valueOf() && ([this._startDate, this._endDate] = [
            this._endDate,
            this._startDate
        ]), this.clear();
        ...
        this._viewPort.callEvent("onDragEnd", [
            this._startPoint,
            this._endPoint
...
class Hn {
    _showAtCoordinates(e, n) {
        this.hide(!0), this._quickInfoBoxId = 0, this._quickInfoTask = null, this._quickInfoBox || (this._createQuickInfoElement(), this.setContent()), this._appendAtCoordinates(e, n), this._gantt.callEvent("onQuickInfo", [
            null
        ]);
    }
    _showForTask(e) {
        ...
        a && (this._quickInfoBox = this._init_quick_info(e), this._quickInfoTask = e, this._quickInfoBox.className = this._prepare_quick_info_classname(e), this._fill_quick_data(e), this._show_quick_info(a, 6), n.callEvent("onQuickInfo", [
            e
        ]));
    }
    ...
    _prepare_quick_info_classname(e) {
        const n = this._gantt, i = n.getTask(e);
        let a = "gantt_cal_quick_info gantt_".concat(n.getTaskType(i));
    ...
    _fill_quick_data(e) {
        ...
        if (this._quickInfoReadonly) {
            const r = n.config.quickinfo_buttons, s = {
                icon_delete: !0,
                icon_edit: !0
            };
    ...
    constructor(e){
        this.show = (n, i)=>{
            ...
            if (this._quickInfoTask = null, a && a.parentNode) {
                if (i.config.quick_info_detached) return i.callEvent("onAfterQuickInfo", [
                    r
                ]), a.parentNode.removeChild(a);
                a.className += " gantt_qi_hidden", a.style.right === "auto" ? a.style.left = "-350px" : a.style.right = "-350px", n && (a.style.left = a.style.right = "", a.parentNode.removeChild(a)), i.callEvent("onAfterQuickInfo", [
                    r
                ]);
            }
            ...
            i._waiAria.quickInfoHeader(r, [
                n.header.title,
                n.header.date
            ].join(" ")), o.innerHTML = n.header.title, l.innerHTML = n.header.date, n.header.title || n.header.date ? s.style.display = "" : s.style.display = "none", c.innerHTML = n.content;
            const u = n.buttons;
            u.length ? d.style.display = "" : d.style.display = "none";
            let h = "";
            for(let _ = 0; _ < u.length; _++){
                const p = i._waiAria.quickInfoButtonAttrString(i.locale.labels[u[_]]);
                h += '<div class="gantt_qi_big_icon '.concat(u[_], " dhx_gantt_").concat(u[_], '" title="').concat(i.locale.labels[u[_]], '" ').concat(p, ">\n            <div class='dhx_menu_icon dhx_gantt_icon ").concat(u[_], " gantt_menu_icon dhx_gantt_").concat(u[_], "'></div>\n            <div>").concat(i.locale.labels[u[_]], "</div>\n         </div>");
            }
...
function q(t) {
    ...
    if (t && typeof t == "object") switch(!0){
        ...
        default:
            ...
            for(e in t)Object.prototype.hasOwnProperty.apply(t, [
                e
            ]) && (n[e] = q(t[e]));
    }
    return n || t;
...
class zn {
    ...
    _calculateTooltipPosition(e) {
        const n = this._gantt, i = this._getViewPortSize(), a = this.getNode(), r = {
            top: 0,
            left: 0,
            width: a.offsetWidth,
            ...
            bottom: 0,
            right: 0
        }, s = n.config.tooltip_offset_x, o = n.config.tooltip_offset_y, l = document.body, c = rt(e, l), d = V(l);
...
class Wn {
    ...
    _initDelayedFunctions() {
        ...
        this.delayShow && this.delayShow.$cancelTimeout(), this.delayHide && this.delayHide.$cancelTimeout(), this.tooltip.hide(), this.delayShow = De((n, i)=>{
            e.callEvent("onBeforeTooltip", [
                n
            ]) === !1 ? this.tooltip.hide() : (this.tooltip.setContent(i), this.tooltip.show(n));
...
class Fn {
    ...
    undo() {
        ...
        if (n && this._reorderCommands(n), e.callEvent("onBeforeUndo", [
            n
        ]) !== !1 && n) return this._applyAction(this.action.invert(n)), this._push(this._redoStack, e.copy(n)), void e.callEvent("onAfterUndo", [
            n
        ]);
        e.callEvent("onAfterUndo", [
            null
        ]);
    }
    redo() {
        ...
        if (n && this._reorderCommands(n), e.callEvent("onBeforeRedo", [
            n
        ]) !== !1 && n) return this._applyAction(n), this._push(this._undoStack, e.copy(n)), void e.callEvent("onAfterRedo", [
            n
        ]);
        e.callEvent("onAfterRedo", [
            null
        ]);
    }
    logAction(e) {
            ...
            for(let o = 0; o < e.commands.length; o++){
                ...
                if (n.type === a.add) r[l](n.oldValue, n.oldValue.parent, n.oldValue.$local_index);
                    ...
                    for(const h in n.value){
                        ...
                        [
                            "$open"
                        ].indexOf(h) > -1 && (_ = !0), _ && (u[h] = n.value[h]);
                    }
                    r[l](n.value.id);
                } else n.type === a.move && (r[l](n.value.id, n.value.$local_index, n.value.parent), r.callEvent("onRowDragEnd", [
                    n.value.id
                ]));
            }
        });
        ...
        this.maxSteps = 100, this.undoEnabled = !0, this.redoEnabled = !0, this.action = {
            ...
            invert: (n)=>{
                ...
                for(let r = 0; r < n.commands.length; r++){
                    ...
                    s.type !== a.type.update && s.type !== a.type.move || ([s.value, s.oldValue] = [
                        s.oldValue,
                        s.value
                    ]);
                }
...
const Vn = {
    ...
    fullscreen: function(t) {
        ...
        function l() {
            ...
            e() ? o && (d = "onExpand", function() {
                ...
                t.callEvent(d, [
                    t.ext.fullscreen.getFullscreenElement()
                ]);
            });
        }
        function c() {
            ...
            e.config.keyboard_navigation = !0, e.config.keyboard_navigation_cells = !1, e.$keyboardNavigation = {}, e._compose = function() {
                ...
                n.$keyboardNavigation.EventHandler = {
                    ...
                    doAction: function(i, a) {
                        ...
                        if (r) {
                            if (n.$keyboardNavigation.facade.callEvent("onBeforeAction", [
                                i,
                                a
                            ]) === !1) return;
                ...
                n.$keyboardNavigation.KeyNavNode = function() {}, n.$keyboardNavigation.KeyNavNode.prototype = n._compose(n.$keyboardNavigation.EventHandler, {
                    ...
                    focus: function() {
                        ...
                        if (i) {
                            ...
                            a.callEvent("onBeforeFocus", [
                                i
                            ]) !== !1 && i && (i.setAttribute("tabindex", "-1"), i.$eventAttached || (i.$eventAttached = !0, n.event(i, "focus", function(r) {
                                return r.preventDefault(), !1;
                            }, !1)), n.utils.dom.isChildOf(document.activeElement, i) && (i = document.activeElement), i.focus && i.focus(), a.callEvent("onFocus", [
                                this.getNode()
                            ]));
                        }
                    },
                    blur: function() {
                        var i = this.getNode();
                        i && (n.$keyboardNavigation.facade.callEvent("onBlur", [
                            i
                ...
                n.$keyboardNavigation.TaskRow = function(i) {
                    ...
                    getNode: function() {
                        if (n.isTaskExists(this.taskId) && n.isTaskVisible(this.taskId)) return n.config.show_grid ? n.$grid.querySelector(".gantt_row[".concat(n.config.task_attribute, '="').concat(String(this.taskId).replaceAll('"', '\\"'), '"]')) : n.getTaskNode(this.taskId);
                    },
                    focus: function(i) {
                        if (!i) {
                        ...
                        n.$keyboardNavigation.KeyNavNode.prototype.focus.apply(this, [
                            i
                        ]), function() {
                ...
                n.$keyboardNavigation.dispatcher = {
                    ...
                    fromDomElement: function(i) {
                        for(var a = [
                            ...
                            n.$keyboardNavigation.HeaderCell
                        ], r = 0; r < a.length; r++)if (a[r].prototype.fromDomElement) {
                    ...
                    keyDownHandler: function(i) {
                        if (!n.$keyboardNavigation.isModal() && this.isEnabled() && !i.defaultPrevented) {
                            ...
                            n.$keyboardNavigation.facade.callEvent("onKeyDown", [
                                r,
                                i
                            ]) !== !1 && (s ? s.findHandler(r) ? s.doAction(r, i) : a.findHandler(r) && a.doAction(r, i) : this.setDefaultNode());
                        }
                    },
                    _timeout: null,
    ...
    quick_info: function(t) {
        t.ext || (t.ext = {}), t.ext.quickInfo = new Hn(t), t.config.quickinfo_buttons = [
            "icon_edit",
            "icon_delete"
        ], t.config.quick_info_detached = !0, t.config.show_quick_info = !0, t.templates.quick_info_title = function(a, r, s) {
    ...
    multiselect: function(t) {
        t.config.multiselect = !0, t.config.multiselect_one_level = !1, t._multiselect = {
            ...
            select: function(e, n) {
                return !!(e && t.callEvent("onBeforeTaskMultiSelect", [
                    e,
                    !0,
                    n
                ]) && t.callEvent("onBeforeTaskSelected", [
                    e
                ])) && (this._selected[e] = !0, this.setLastSelected(e), this.afterSelect(e), t.callEvent("onTaskMultiSelect", [
                    e,
                    !0,
                    n
                ]), t.callEvent("onTaskSelected", [
                    e
                ]), !0);
            },
            toggle: function(e, n) {
            ...
            unselect: function(e, n) {
                e && t.callEvent("onBeforeTaskMultiSelect", [
                    ...
                    !1,
                    n
                ]) && (this._selected[e] = !1, this.getLastSelected() == e && this.setLastSelected(this.getDefaultSelected()), this.afterSelect(e), t.callEvent("onTaskMultiSelect", [
                    e,
                    !1,
                    n
                ]), t.callEvent("onTaskUnselected", [
                    e
                ]));
            },
            ...
            doSelection: function(e) {
                ...
                var n = t.locate(e);
                if (!n || !t.callEvent("onBeforeMultiSelect", [
                    e
                ])) return !1;
            ...
            return t._multiselect.doSelection(n) && t.callEvent("onMultiSelect", [
                n
            ]), !0;
        });
    },
    export_api: function(t) {
        return t.ext = t.ext || {}, t.ext.export_api = t.ext.export_api || {
            ...
            _copyObjectAll (e) {
                const n = t.ext.export_api._copyObjectBase(e), i = [
                    "leftside_text",
                    "rightside_text",
                    "task_text",
                    "progress_text",
            ...
            _onCircDependencyFind (e, n, i, a) {
                e && (t.callEvent("onExportCircularDependency", [
                    e.id,
                    e
                ]) && delete n[e.id], delete i[e._source], delete i[e._target], a[e.id] = !0);
            },
            ...
            _exportConfig (e, n) {
                ...
                const s = n.auto_scheduling !== void 0 && !!n.auto_scheduling, o = {
            ...
            _sendImportAjaxMSP (e) {
                const n = e.server || t.ext.export_api._apiUrl, i = e.store || 0, a = e.data, r = e.callback, s = {
...
const Le = {
    date_to_str: (t, e, n)=>{
        t = t.replace(/%[a-zA-Z]/g, (a)=>{
            switch(a){
                case "%d":
                    return '"+to_fixed(date.get'.concat(e ? "UTC" : "", 'Date())+"');
                case "%m":
                    return '"+to_fixed((date.get'.concat(e ? "UTC" : "", 'Month()+1))+"');
                case "%j":
                    return '"+date.get'.concat(e ? "UTC" : "", 'Date()+"');
                case "%n":
                    return '"+(date.get'.concat(e ? "UTC" : "", 'Month()+1)+"');
                case "%y":
                    return '"+to_fixed(date.get'.concat(e ? "UTC" : "", 'FullYear()%100)+"');
                case "%Y":
                    return '"+date.get'.concat(e ? "UTC" : "", 'FullYear()+"');
                case "%D":
                    return '"+locale.date.day_short[date.get'.concat(e ? "UTC" : "", 'Day()]+"');
                case "%l":
                    return '"+locale.date.day_full[date.get'.concat(e ? "UTC" : "", 'Day()]+"');
                case "%M":
                    return '"+locale.date.month_short[date.get'.concat(e ? "UTC" : "", 'Month()]+"');
                case "%F":
                    return '"+locale.date.month_full[date.get'.concat(e ? "UTC" : "", 'Month()]+"');
                case "%h":
                    return '"+to_fixed((date.get'.concat(e ? "UTC" : "", 'Hours()+11)%12+1)+"');
                case "%g":
                    return '"+((date.get'.concat(e ? "UTC" : "", 'Hours()+11)%12+1)+"');
                case "%G":
                    return '"+date.get'.concat(e ? "UTC" : "", 'Hours()+"');
                case "%H":
                    return '"+to_fixed(date.get'.concat(e ? "UTC" : "", 'Hours())+"');
                case "%i":
                    return '"+to_fixed(date.get'.concat(e ? "UTC" : "", 'Minutes())+"');
                case "%a":
                    return '"+(date.get'.concat(e ? "UTC" : "", 'Hours()>11?"pm":"am")+"');
                case "%A":
                    return '"+(date.get'.concat(e ? "UTC" : "", 'Hours()>11?"PM":"AM")+"');
                case "%s":
                    return '"+to_fixed(date.get'.concat(e ? "UTC" : "", 'Seconds())+"');
                case "%W":
        ...
        const i = new Function("date", "to_fixed", "locale", "getISOWeek", "getWeek", 'return "'.concat(t, '";'));
    ...
    str_to_date: (t, e, n)=>{
        ...
        for(let o = 0; o < a.length; o++)switch(a[o]){
            case "%j":
            case "%d":
                i += "set[2]=temp[".concat(o, "]||1;");
                break;
            case "%n":
            case "%m":
                i += "set[1]=(temp[".concat(o, "]||1)-1;");
                break;
            case "%y":
                i += "set[0]=temp[".concat(o, "]*1+(temp[").concat(o, "]>50?1900:2000);");
                break;
            case "%g":
            case "%G":
            case "%h":
            case "%H":
                i += "set[3]=temp[".concat(o, "]||0;");
                break;
            case "%i":
                i += "set[4]=temp[".concat(o, "]||0;");
                break;
            case "%Y":
                i += "set[0]=temp[".concat(o, "]||0;");
                break;
            case "%a":
            case "%A":
                i += "set[3]=set[3]%12+((temp[".concat(o, "]||'').toLowerCase()=='am'?0:12);");
                break;
            case "%s":
                i += "set[5]=temp[".concat(o, "]||0;");
                break;
            case "%M":
                i += "set[1]=locale.date.month_short_hash[temp[".concat(o, "]]||0;");
                break;
            case "%F":
                i += "set[1]=locale.date.month_full_hash[temp[".concat(o, "]]||0;");
        }
        let r = "set[0],set[1],set[2],set[3],set[4],set[5]";
        e && (r = " Date.UTC(".concat(r, ")"));
        const s = new Function("date", "locale", "var set=[0,0,1,0,0,0]; ".concat(i, " return new Date(").concat(r, ");"));
    ...
    str_to_date: (t, e, n)=>(i)=>{
            const a = [
                ...
                0,
                0
            ], r = i.match(/[a-zA-Z]+|[0-9]+/g), s = t.match(/%[a-zA-Z]/g);
...
class Yn {
    ...
    connect() {
        ...
        e && (this._socket = null, e.onclose = function() {}, e.close()), this._mode = 2, this._socket = function(n, i, a, r) {
            ...
            const o = s.indexOf("?") != -1 ? "&" : "?";
            s = "".concat(s).concat(o, "token=").concat(a, "&ws=1");
    ...
    _send(e) {
        ...
        const n = e ? [
            e
        ] : this._queue.filter((a)=>a.status === 1);
        if (!n.length) return;
    ...
    result(e, n) {
        ...
        else for(let a = 0; a < n.length; a++)i[n[a].id] = {
            id: n[a].id,
            error: "Network Error",
            data: null
        };
...
it.prototype = {
    ...
    _parseInner: function(t) {
        for(var e = null, n = [], i = 0, a = t.length; i < a; i++)e = t[i], this.$initItem && (this.$config.copyOnParse() && (e = q(e)), e = this.$initItem(e)), this.callEvent("onItemLoading", [
            e
        ]) && (this.pull.hasOwnProperty(e.id) || this.fullOrder.push(e.id), n.push(e), this.pull[e.id] = e);
        return n;
    },
    parse: function(t) {
        this.isSilent() || this.callEvent("onBeforeParse", [
            t
        ]);
        var e = this._parseInner(t);
        this.isSilent() || (this.refresh(), this.callEvent("onParse", [
            e
        ]));
    },
    getItem: function(t) {
    ...
    updateItem: function(t, e) {
        if (W(e) || (e = this.getItem(t)), !this.isSilent() && this.callEvent("onBeforeUpdate", [
            e.id,
            e
        ]) === !1) return !1;
        P(this.pull[t], e, !0), this.isSilent() || (this.callEvent("onAfterUpdate", [
            e.id,
            e
    ...
    removeItem: function(t) {
        ...
        if (!this.isSilent() && this.callEvent("onBeforeDelete", [
            e.id,
            e
        ]) === !1) return !1;
        this.callEvent("onAfterDeleteConfirmed", [
            e.id,
            e
        ]), this._removeItemInner(t), this.isSilent() && this.callEvent("onAfterSilentDelete", [
            e.id,
            e
        ]), this.isSilent() || (this.filter(), this.callEvent("onAfterDelete", [
            e.id,
            e
        ]), this.callEvent("onStoreUpdated", [
            e.id,
    ...
    addItem: function(t, e) {
        return W(t.id) || (t.id = st()), this.$initItem && (t = this.$initItem(t)), !(!this.isSilent() && this.callEvent("onBeforeAdd", [
            t.id,
            t
        ]) === !1) && (this._addItemInner(t, e), this.isSilent() || (this.callEvent("onAfterAdd", [
            t.id,
            t
        ]), this.callEvent("onStoreUpdated", [
            t.id,
    ...
    changeId: function(t, e) {
        this._changeIdInner(t, e), this.callEvent("onIdChange", [
            t,
            e
        ]);
    },
    ...
    move: function(t, e) {
        ...
        this._moveInner(t, e), this.isSilent() || this.callEvent("onStoreUpdated", [
            i.id,
            i,
            "move"
        ]);
    ...
    refresh: function(t, e) {
        var n, i;
        if (!this.$destroyed && !this.isSilent() && (t && (n = this.getItem(t)), i = t ? [
            t,
            n,
            "paint"
        ] : [
    ...
    filter: function(t) {
        ...
        this.eachItem(function(a) {
            this.callEvent("onFilterItem", [
                a.id,
                a
            ]) && (Rt(a.id, null, this, this._ganttConfig) ? n.push(a.id) : e.push(a.id));
        });
...
var cn = function(t) {
    ...
    it.apply(this, [
        t
    ]), this._branches = {}, this.pull = {}, this.$initItem = function(o) {
        var l = o;
...
cn.prototype = P({
    ...
    parse: function(t) {
        this._skip_refresh || this.callEvent("onBeforeParse", [
            t
        ]);
        var e = this._parseInner(t);
        this._buildTree(e), this.filter(), this._skip_refresh || this.callEvent("onParse", [
            e
        ]);
    },
    _addItemInner: function(t, e) {
    ...
    move: function(t, e, n) {
        ...
        if (!lt(t, n)) {
            ...
            if (this.callEvent("onBeforeItemMove", [
                t,
                n,
                e
            ]) === !1) return !1;
            ...
            (d = at(d, a)) ? o = o.slice(0, e).concat([
                t
            ]).concat(o.slice(e)) : o.push(t), l.length && (o = o.concat(l)), lt(r.$rendered_parent, s) || lt(s, n) || (r.$rendered_parent = s), this.setParent(r, n), this._branches[n] = o;
            var u = this.calculateItemLevel(r) - r.$level;
            r.$level += u, this.eachItem(function(h) {
                h.$level += u;
            }, r.id, this), this._moveInner(this.getIndexById(t), this.getIndexById(n) + e), this.callEvent("onAfterItemMove", [
                t,
                n,
                e
            ]), this.refresh();
    ...
    open: function(t) {
        this.exists(t) && (this.getItem(t).$open = !0, this._skipTaskRecalculation = !0, this.callEvent("onItemOpen", [
            t
        ]));
    },
    close: function(t) {
        this.exists(t) && (this.getItem(t).$open = !1, this._skipTaskRecalculation = !0, this.callEvent("onItemClose", [
            t
        ]));
    },
    destructor: function() {
...
const Zn = function(t, e) {
    ...
    n.attachEvent("onStoreUpdated", function(o, l, c) {
        ...
        s(e) || (o && c != "move" && c != "delete" ? (n.callEvent("onBeforeRefreshItem", [
            l.id
        ]), n.callEvent("onAfterRefreshItem", [
            l.id
        ])) : (n.callEvent("onBeforeRefreshAll", []), n.callEvent("onAfterRefreshAll", [])));
        ...
        if (F(e)) return !0;
        if (n.callEvent("onBeforeIdChange", [
            o,
            l
        ]), !s(e) && !n.isSilent()) {
        ...
        var t = P({}, {
            createDatastore: function(e) {
                ...
                if (this.mixin(a, function(o) {
                    ...
                    function d(u) {
                        l = null, this.callEvent("onAfterUnselect", [
                            u
                        ]);
                    }
                    return o._removeItemInner = function(u) {
                        ...
                        select: function(u) {
                            if (u) {
                                if (l == u) return l;
                                if (!this._skip_refresh && !this.callEvent("onBeforeSelect", [
                                    u
                                ])) return !1;
                                this.unselect(), l = u, this._skip_refresh || (this.refresh(u), this.callEvent("onAfterSelect", [
                                    u
                                ]));
                            }
                            return l;
        ...
        return P(t, {
            ...
            addTask: function(e, n, i) {
                ...
                if (W(n) || (n = this.getParent(e) || 0), this.isTaskExists(n) || (n = this.config.root_id), this.setParent(e, n), this.getState().lightbox && this.isTaskExists(n)) {
                    ...
                    this.callEvent("onAfterParentExpand", [
                        n,
                        a
                    ]);
                }
            ...
            sort: function(e, n, i, a) {
                var r = !a;
                this.$data.tasksStore.sort(e, n, i), this.callEvent("onAfterSort", [
                    e,
                    n,
                    i
                ]), r && this.render();
...
class ei {
    attach() {
        ...
        this._dataProcessorHandlers.push(n.attachEvent("onTaskIdChange", function(o, l) {
            ...
            const u = o.data || n.xml._xmlNodeToJSON(o.firstChild), h = {
                add: n.addTask,
...
let Jt = Xt, un = class {
    ...
    markRow(t, e, n) {
        ...
        if (a && (i = this.styles[a], e = !0), this.callEvent("onRowMark", [
            t,
            e,
            n,
            a
        ]) && (i = this.styles[e ? n : "clear"] + " " + i, this.$gantt[this._methods[0]](t, i), a && a.details)) {
    ...
    sendData(t) {
        ...
        return !this._in_progress[t] && (this.messages = [], !(!this.checkBeforeUpdate(t) && this.callEvent("onValidationError", [
            t,
            this.messages
    ...
    sendAllData() {
        ...
        }), !t && !this.callEvent("onValidationError", [
            "",
            this.messages
        ])) return !1;
    ...
    afterUpdateCallback(t, e, n, i, a) {
            ...
            case "deleted":
                if (this.deleteAfterConfirmation && this._ganttMode === "task") {
                    if (this._ganttMode === "task" && this.$gantt.isTaskExists(t)) {
                        ...
                        }), this.$gantt.callEvent("onAfterTaskDelete", [
                            t,
                            l
                        ]), this.$gantt.render(), delete this._in_progress[r];
                    }
                    return this.callEvent("onAfterUpdate", [
                        t,
                        n,
                        e,
                        i
                ...
                return this.$gantt.setUserData(t, this.action_param, "true_deleted", this._ganttMode), this.$gantt[this._methods[3]](t), delete this._in_progress[r], this.callEvent("onAfterUpdate", [
                    t,
                    n,
                    e,
                    i
        ...
        this._in_progress[r] !== "wait" ? (s && this.$gantt.setUserData(t, this.action_param, "", this._ganttMode), delete this._in_progress[r]) : (delete this._in_progress[r], this.setUpdated(e, !0, this.$gantt.getUserData(t, this.action_param, this._ganttMode))), this.callEvent("onAfterUpdate", [
            o,
            n,
            e,
            i
    ...
    init(t) {
            ...
            n.getUserData = function(a, r, s) {
                ...
                switch(this._dp._ganttMode){
                    ...
                    case "baseline":
                        ...
                        break;
                    default:
                        throw new Error("Invalid mode of the dataProcessor after database id is received: ".concat(this._dp._ganttMode, ", new id: ").concat(r));
                }
        ...
        }), this.$gantt.callEvent("onDataProcessorReady", [
            this
        ]), this._initialized = !0;
    }
    setOnAfterUpdate(t) {
    ...
    loadUpdate() {
        ...
        let n = this.serverProcessor + t.urlSeparator(this.serverProcessor) + [
            "dhx_user=" + this._user,
            "dhx_version=" + e
        ].join("&");
    ...
    _sendData(t, e) {
        if (!t) return;
        if (!this.callEvent("onBeforeDataSending", e ? [
            e,
            this.getState(e),
            t
        ] : [
        ...
        if (this._tMode === "CUSTOM") {
            ...
            if (this._router instanceof Function) if (this._routerParametersFormat === "object") {
                ...
                if (!this._router[d]) throw new Error("".concat(_, ": router for the **").concat(d, "** entity is not defined. ").concat(p));
                switch(l){
                    case "inserted":
                        if (!this._router[d].create) throw new Error("".concat(_, ": **create** action for the **").concat(d, "** entity is not defined. ").concat(p));
                        h = this._router[d].create(t);
                        break;
                    case "deleted":
                        if (!this._router[d].delete) throw new Error("".concat(_, ": **delete** action for the **").concat(d, "** entity is not defined. ").concat(p));
                        h = this._router[d].delete(e);
                        break;
                    default:
                        if (!this._router[d].update) throw new Error("".concat(_, ': **update**" action for the **').concat(d, "** entity is not defined. ").concat(p));
        ...
        const a = "dhx_version=" + this.$gantt.getUserData(0, "version", this._ganttMode), r = this.serverProcessor + (this._user ? n.urlSeparator(this.serverProcessor) + [
            "dhx_user=" + this._user,
            a
        ].join("&") : "");
    ...
    _getAllData() {
        ...
        return this._forEachUpdatedRow(function(n) {
            ...
            this.callEvent("onBeforeUpdate", [
                ...
                this.getState(n),
                i
            ]) && (t[n] = i, e = !0, this._in_progress[n] = /* @__PURE__ */ new Date().valueOf());
        }), e ? t : null;
    }
    _prepareDate(t) {
...
function oi(t) {
    ...
    function r(l, c, d) {
        return Array.isArray(l) ? l.map(function(u) {
            return a(u);
        }).join("_") + "_".concat(c, "_").concat(d) : a(l) + "_".concat(c, "_").concat(d);
    }
    function s(l, c, d) {
...
function di(t) {
    ...
    function _(f, v) {
        ...
        var x, $, w = f.delay ? t.calculateEndDate({
            start_date: v.start_date,
            duration: f.delay,
            task: v
...
Qt.create = function() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, n = arguments.length > 1 ? arguments[1] : void 0;
    return new Qt(n);
};
let ke = Qt;
function hi(t) {
...
function _i(t) {
    t.ext = t.ext || {}, t.config.show_empty_state = !1, t.ext.emptyStateElement = t.ext.emptyStateElement || {
        ...
        renderContent (e) {
            const n = "<div class='gantt_empty_state'><div class='gantt_empty_state_image'></div>".concat("<div class='gantt_empty_state_text'>\n    <div class='gantt_empty_state_text_link' data-empty-state-create-task>".concat(t.locale.labels.empty_state_text_link, "</div>\n    <div class='gantt_empty_state_text_description'>").concat(t.locale.labels.empty_state_text_description, "</div>\n    </div>"), "</div>");
            e.innerHTML = n;
        },
        clickEvents: [],
        attachAddTaskEvent () {
...
ye.prototype = {
    ...
    _checkIfWorkingUnit: function(t, e) {
        if (!this["_is_work_" + e]) {
            const n = this.$gantt.date["".concat(e, "_start")](new Date(t)), i = this.$gantt.date.add(n, 1, e);
...
function $i(t) {
    ...
    var e = function(s, o) {
        ...
        if (l) if (t.config.schedule_from_end) c = t.calculateEndDate({
    ...
    t._set_default_task_timing = function(s) {
        ...
        if (s = s || {}, t.defined(s.id) || (s.id = t.uid()), s.start_date || (s.start_date = e(s, o)), s.text === void 0 && (s.text = t.locale.labels.new_task), s.duration === void 0 && (s.duration = 1), this.isTaskExists(o)) {
            ...
            c.$open = !0, this.config.details_on_create || this.callEvent("onAfterParentExpand", [
                o,
                c
            ]);
        }
        return this.callEvent("onTaskCreated", [
            s
        ]) ? (this.config.details_on_create ? (t.isTaskExists(s.id) ? t.getTask(s.id).$index != s.$index && (s.start_date && typeof s.start_date == "string" && (s.start_date = this.date.parseDate(s.start_date, "parse_date")), s.end_date && typeof s.end_date == "string" && (s.end_date = this.date.parseDate(s.end_date, "parse_date")), this.$data.tasksStore.updateItem(s.id, s)) : (s.$new = !0, this.silent(function() {
...
function wi(t) {
    t.assert = /* @__PURE__ */ function(r) {
        return function(s, o) {
            s || r.config.show_errors && r.callEvent("onError", [
                o
            ]) !== !1 && (r.message ? r.message({
                type: "error",
                text: o,
                expire: -1
            }) : console.log(o));
    ...
    t.resetLayout = function() {
        ...
        var d = !0;
        return this.checkEvent("onLinkValidation") && (d = this.callEvent("onLinkValidation", [
            c
        ])), d;
...
function ra(t) {
    ...
    e.plugins = function(l) {
        ...
        return {
            ...
            xmltop: function(c, d, u) {
                ...
                return u !== -1 && l.callEvent("onLoadXMLError", [
                    "Incorrect XML",
                    arguments[1],
                    u
                ...
                return new l.Promise(function(y, k) {
                    ...
                    h && (b.onreadystatechange = function() {
                        if (b.readyState == 4 || g && b.readyState == 3) {
                            if ((b.status < 200 || b.status > 299 || b.responseText === "") && !l.callEvent("onAjaxError", [
                                b
                            ])) return;
                            setTimeout(function() {
    ...
    var a = function(l) {
        ...
        return d.prototype = {
            traceDragEvents: function(u, h) {
                ...
                }, this), y = vt(l.$root), k = this.config.mousemoveContainer || vt(l.$root), b = {
                    passive: !1
                }, g = R(function(m) {
            ...
            dragMove: function(u, h, _) {
                ...
                if (!this.config.marker && !this.config.started) {
                    ...
                    if (l.config.touch || this.checkPositionChange(y)) {
                        if (this.config.started = !0, this.config.ignore = !1, l._touch_drag = !0, this.callEvent("onBeforeDragStart", [
                            u,
                            this.config.original_target
                        ]) === !1) return this.config.ignore = !0, !1;
                        this.backupEventTarget(h, _), this.initDnDMarker(), l._touch_feedback(), this.callEvent("onAfterDragStart", [
                            u,
                            this.config.original_target
                        ]);
                    } else this.config.ignore = !0;
                }
                return this.config.ignore ? !1 : h.targetTouches && !p.target ? void 0 : (p.pos = this.getPosition(p), this.config.marker.style.left = p.pos.x + "px", this.config.marker.style.top = p.pos.y + "px", this.callEvent("onDragMove", [
                    u,
                    p
                ]), !0);
            },
            ...
            initTemplates: function() {
                ...
                d("date_scale", !0, void 0, l.config, l.templates), d("date_grid", !0, "grid_date_format", l.config, l.templates), d("task_date", !0, void 0, l.config, l.templates), l.mixin(l.templates, {
                    ...
                    tooltip_text: function(k, b, g) {
                        return "<div>Task: ".concat(g.text, "</div>\n				<div>Start date: ").concat(l.templates.tooltip_date_format(k), "</div>\n				<div>End date: ").concat(l.templates.tooltip_date_format(b), "</div>");
                    },
    ...
    s.registerProvider("global", function() {
        ...
        l.attachEvent("onDestroy", function() {
            ...
            return !(!v || !x || l._isAllowedUnscheduledTask(l.getTask(f.source)) || l._isAllowedUnscheduledTask(l.getTask(f.target))) && l.callEvent("onBeforeLinkDisplay", [
                m,
                f
            ]);
...
function sa(t) {
    ...
    function l() {
        for(var g = [].slice.apply(arguments, [
            0
        ]), m = 0; m < g.length; m++)if (g[m]) return g[m];
    }
    function c(g, m, f) {
        ...
        return g.position == "top" ? v.style.top = "-3px" : v.style.top = $ + "px", v.style.left = x + "px", v.onkeydown = a, y.focus(v), g.hidden && y.hide(v), t.callEvent("onMessagePopup", [
            v
        ]), v;
    }
    function d(g) {
    ...
    y.hide = function(g) {
        ...
        g && (g.parentNode.removeChild(g), s(!1), t.callEvent("onAfterMessagePopup", [
            g
        ]));
    }, y.focus = function(g) {
        setTimeout(function() {
...
var da = /* @__PURE__ */ function(t) {
    return function(e) {
        ...
        function a(h) {
            ...
            if (_ !== null ? y = !e.checkEvent("onTaskClick") || e.callEvent("onTaskClick", [
                _,
                h
            ]) : e.callEvent("onEmptyClick", [
                h
            ]), y) {
                if (!o(p, h, _)) return;
        ...
        function r(h) {
            var _ = (h = h || window.event).target || h.srcElement, p = e.locate(_), y = e.locate(_, e.config.link_attribute), k = !e.checkEvent("onContextMenu") || e.callEvent("onContextMenu", [
                p,
                y,
                h
            ]);
        ...
        function l(h) {
            h = h || window.event;
            var _ = e.locate(h), p = s(h, n.doubleclick), y = !e.checkEvent("onTaskDblClick") || _ === null || e.callEvent("onTaskDblClick", [
                _,
                h
            ]);
            if (y) {
        ...
        function c(h) {
            if (e.checkEvent("onMouseMove")) {
                var _ = e.locate(h);
                e._last_move_event = h, e.callEvent("onMouseMove", [
                    _,
                    h
                ]);
            }
...
var kn = function(t) {
    ...
    return z(e, t), e.prototype.destructor = function() {
        ...
        for(r = 0; r < i.length; r++)if (!i[r].$config.hidden) {
            var s = r >= a, o = "";
            !s && i[r + 1] && i[r + 1].$config.view == "scrollbar" && (this._xLayout ? s = !0 : o = "gantt_layout_cell_border_transparent"), this._setBorders(s ? [] : [
                n,
                o
            ], i[r]);
        }
    ...
    return z(n, t), n.prototype.init = function(a) {
        ...
        if (!this._scrolling) {
            ...
            this.$config.scrollPosition = a, this.callEvent("onScroll", [
                o,
                a,
                this.$config.scroll
            ]), this._scrolling = !1;
...
Ut.prototype = {
    ...
    scrollTo: function(t, e) {
        if (this.isVisible()) {
            var n = !1;
            this.$config.scrollTop = this.$config.scrollTop || 0, this.$config.scrollLeft = this.$config.scrollLeft || 0, 1 * e === e && (this.$config.scrollTop = e, this.$task_data.scrollTop = this.$config.scrollTop, n = !0), 1 * t === t && (this.$task.scrollLeft = t, this.$config.scrollLeft = this.$task.scrollLeft, this._refreshScales(), n = !0), n && this.callEvent("onScroll", [
    ...
    _prepareScaleHtml: function(t, e, n, i) {
        ...
        for(var h = d; h < u && t.trace_x[h]; h++){
            ...
            if (p) {
                ...
                const $ = 70;
                if (v !== !1 && p > $ || v === !0) {
                    if (y < f.x && y + p / 2 - $ / 2 < f.x) x = " style='position:absolute;left: ".concat(f.x - y + 10, "px;' ");
                    else if (y + p / 2 + $ / 2 > f.x_end && p > $) {
                        let w = f.x_end - y - 10, S = "-100%";
                        w < $ && (w = $, S = "-".concat(w, "px")), x = " style='position:absolute;left: ".concat(w, "px;transform: translate(").concat(S, ",0);' ");
                    }
                }
                g = "gantt_scale_cell" + (h == t.count - 1 ? " gantt_last_cell" : ""), (b = l.call(this, o)) && (g += " " + b);
                var m = "<div class='".concat(g, "' ").concat(this.$gantt._waiAria.getTimelineCellAttr(_), " style='").concat(k, "'><span ").concat(x, ">").concat(_, "</span></div>");
                s.push(m);
            }
        }
        return s.join("");
    ...
    _getScales: function() {
        var t = this.$getConfig(), e = this.$scaleHelper, n = [
            e.primaryScale(t)
        ].concat(e.getSubScales(t));
...
class va {
    ...
    setMarkerPosition(e) {
        let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 10;
        const { marker: i } = this._dnd.config, a = this._dnd._obj.getBoundingClientRect();
        i.style.top = "".concat(a.y + n, "px"), i.style.left = "".concat(e, "px");
    }
    drawTargetMarker(param) {
        let { targetIndex: e, draggedIndex: n, xBefore: i, xAfter: a, columnRelativePos: r } = param;
        let s;
        this._targetMarker || (this._targetMarker = document.createElement("div"), wt(this._targetMarker, "gantt_grid_target_marker"), this._targetMarker.style.display = "none", this._targetMarker.style.height = "".concat(this._gridConfig.scale_height, "px")), this._targetMarker.parentNode || this.$grid.$grid_scale.appendChild(this._targetMarker), s = e > n ? a : e < n ? i : r > 0.5 ? a : i, this._targetMarker.style.left = "".concat(s, "px"), this._targetMarker.style.display = "block";
    }
    cleanTargetMarker() {
    ...
    return {
        delegate: function(n, i, a, r) {
            e.push([
                ...
                a,
                r
            ]), t.$services.getService("mouseEvents").delegate(n, i, a, r);
        },
        destructor: function() {
...
xe.prototype = {
        ...
        var c = function(d, u) {
            var h = {
                row_before_start: d.bind(function(_, p, y) {
                    ...
                    return u.callEvent("onBeforeRowResize", [
                        m
                    ]) !== !1 && void 0;
                }, d),
                ...
                row_drag_move: d.bind(function(_, p, y) {
                    ...
                    return (S = $ - w) < T && (S = T), g.marker.style.left = x.x + "px", g.marker.style.top = w - 1 + "px", g.marker.style.height = Math.abs(S) + 1 + "px", g.marker_height = S, u.callEvent("onRowResize", [
                        m,
                        k.getItem(m),
                        S + f
                    ]), !0;
                ...
                row_drag_end: d.bind(function(_, p, y) {
                    ...
                    u.callEvent("onBeforeRowResizeEnd", [
                        g,
                        m,
                        v
                    ]) !== !1 && m.row_height != v && (m.row_height = v, k.updateItem(g), u.callEvent("onAfterRowResize", [
                        g,
                        m,
                        f,
                        v
            ...
            return {
                init: function() {
                    var _ = d.$services.getService("dnd"), p = u.$getConfig(), y = new _(u.$grid_data, {
                        updates_per_second: 60
                    });
    ...
    scrollTo: function(t, e) {
        if (this.isVisible()) {
            var n = !1;
            this.$config.scrollTop = this.$config.scrollTop || 0, this.$config.scrollLeft = this.$config.scrollLeft || 0, 1 * t == t && (this.$config.scrollLeft = this.$state.scrollLeft = this.$grid.scrollLeft = t, n = !0), 1 * e == e && (this.$config.scrollTop = this.$state.scrollTop = this.$grid_data.scrollTop = e, n = !0), n && this.callEvent("onScroll", [
                this.$config.scrollLeft,
                this.$config.scrollTop
            ]);
        }
    ...
    _renderGridHeader: function() {
        ...
        for(var d = 0; d < a.length; d++){
            ...
            var y = t._sort && h.name == t._sort.name ? '<div data-column-id="'.concat(h.name, '" class="gantt_sort gantt_').concat(t._sort.direction, '"></div>') : "", k = [
                "gantt_grid_head_cell",
                "gantt_grid_head_" + h.name,
                u ? "gantt_last_cell" : "",
                i.grid_header_class(h.name, h)
            ].join(" "), b = "width:" + (_ - (u ? 1 : 0)) + "px;", g = h.label || o["column_" + h.name] || o[h.name];
...
function ba(t) {
    ...
    return z(n, e), P(n.prototype, {
        show: function(i, a, r, s) {
            var o = "<div role='cell'><input type='text' name='".concat(a.name, "' title='").concat(a.name, "'></div>");
            s.innerHTML = o;
        }
    }, !0), n;
}
function xa(t) {
    ...
    return z(n, e), P(n.prototype, {
        show: function(i, a, r, s) {
            var o = r.min || 0, l = r.max || 100, c = "<div role='cell'><input type='number' min='".concat(o, "' max='").concat(l, "' name='").concat(a.name, "' title='").concat(a.name, "'></div>");
...
function $a(t) {
    ...
    return z(n, e), P(n.prototype, {
        show: function(i, a, r, s) {
            for(var o = "<div role='cell'><select name='".concat(a.name, "' title='").concat(a.name, "'>"), l = [], c = r.options || [], d = 0; d < c.length; d++)l.push("<option value='" + r.options[d].key + "'>" + c[d].label + "</option>");
...
function wa(t) {
    ...
    return z(r, e), P(r.prototype, {
        show: function(s, o, l, c) {
            ...
            var h = "<div style='width:140px' role='cell'><input type='date' ".concat(d ? " min='" + i(d) + "' " : "", " ").concat(u ? " max='" + i(u) + "' " : "", " name='").concat(o.name, "' title='").concat(o.name, "'></div>");
...
function Sa(t) {
    ...
    return z(n, e), P(n.prototype, {
        show: function(l, c, d, u) {
            var h = "<div role='cell'><input type='text' name='".concat(c.name, "' title='").concat(c.name, "'></div>");
            u.innerHTML = h;
        },
        hide: function() {},
...
function Ta(t) {
    ...
    return z(n, e), P(n.prototype, {
        show: function(a, r, s, o) {
            var l = "<div role='cell'><input type='text' name='".concat(r.name, "' title='").concat(r.name, "'></div>");
            o.innerHTML = l;
        },
    ...
    var i = {
        ...
        createEditors: function(a) {
            function r(u, h) {
                ...
                return y.setAttribute("data-column-index", k), t._waiAria.inlineEditorAttr(y), _.rtl ? y.style.cssText = [
                    "top:" + p.top + "px",
                    "right:" + p.right + "px",
                    "width:" + p.width + "px",
                    "height:" + p.height + "px"
                ].join(";") : y.style.cssText = [
                    "top:" + p.top + "px",
                    "left:" + p.left + "px",
                    "width:" + p.width + "px",
                    "height:" + p.height + "px"
            ...
            var s = Ea(t), o = [], l = [], c = null, d = {
                ...
                startEdit: function(u, h) {
                    ...
                    if (t.isReadonly(c.getItem(u))) return void this.callEvent("onEditPrevent", [
                        _
                    ]);
                    if (this.callEvent("onBeforeEditStart", [
                        _
                    ]) === !1) return void this.callEvent("onEditPrevent", [
                        _
                    ]);
                    const p = this.show(_.id, _.columnName);
                    p && p.then ? p.then((function() {
                        this.setValue(), this.callEvent("onEditStart", [
                            _
                        ]);
                    }).bind(this)) : (this.setValue(), this.callEvent("onEditStart", [
                        _
                    ]));
                },
                isVisible: function() {
                ...
                show: function(u, h) {
                    ...
                    var _ = {
                        id: u,
                        columnName: h
                    }, p = a.getColumn(_.columnName), y = this.getEditorConfig(p.name);
                    if (!y) return;
                ...
                save: function() {
                    if (this.isVisible() && c.exists(this._itemId) && this.isChanged()) {
                        ...
                        if (c.exists(u)) {
                            var _ = c.getItem(u), p = this.getEditorConfig(h), y = {
                                id: u,
                                columnName: h,
                                newValue: this.getValue(),
                                oldValue: this._getItemValue()
                            };
                            if (this.callEvent("onBeforeSave", [
                                y
                            ]) !== !1 && (!this._editor.is_valid || this._editor.is_valid(y.newValue, y.id, a.getColumn(h), this._placeholder))) {
                                var k = p.map_to, b = y.newValue;
                                k != "auto" ? (_[k] = b, s(_, k, t.config.inline_editors_date_processing), c.updateItem(u)) : this._editor.save(u, a.getColumn(h), this._placeholder), this.callEvent("onSave", [
                                    y
                                ]);
                            }
                            this.hide();
...
function bn(t) {
    ...
    function a(r, s, o, l, c, d) {
        var u, h = t.getState();
        +o.start_date >= +h.min_date && ((u = l([
            s,
            c.rtl ? "task_right" : "task_left",
            "task_start_date"
        ].join(" "))).setAttribute("data-bind-property", "start_date"), d && (u.style.marginLeft = d + "px"), r.appendChild(u)), +o.end_date <= +h.max_date && ((u = l([
            s,
            c.rtl ? "task_left" : "task_right",
            "task_end_date"
        ].join(" "))).setAttribute("data-bind-property", "end_date"), d && (u.style.marginRight = d + "px"), r.appendChild(u));
    }
    ...
    var e = {
        ...
        render_line: function(a, r, s, o) {
            ...
            c.style.cssText = [
                ...
                "height:" + l.height + "px",
                "width:" + l.width + "px"
            ].join(";"), c.className = "gantt_line_wrapper";
            var d = this.get_line_sizes(a, s), u = document.createElement("div");
            return u.style.cssText = [
                "height:" + d.height + "px",
                "width:" + d.width + "px",
                "margin-top:" + d.marginTop + "px",
                "margin-left:" + d.marginLeft + "px"
            ].join(";"), u.className = "gantt_link_line_" + a.direction, c.appendChild(u), c;
        },
        render_corner: function(a, r) {
            const s = a.radius, o = r.$getConfig(), l = o.link_line_width || 2, c = document.createElement("div");
            let d, u;
            return c.classList.add("gantt_link_corner"), c.classList.add("gantt_link_corner_".concat(a.direction.from, "_").concat(a.direction.to)), c.style.width = "".concat(s, "px"), c.style.height = "".concat(s, "px"), a.direction.from === "right" && a.direction.to === "down" ? (d = "Right", u = "Top", c.style.left = a.x - o.link_line_width / 2 + "px", c.style.top = "".concat(a.y, "px")) : a.direction.from === "down" && a.direction.to === "right" ? (d = "Left", u = "Bottom", c.style.left = a.x - o.link_line_width / 2 + "px", c.style.top = "".concat(a.y, "px")) : a.direction.from === "right" && a.direction.to === "up" ? (d = "Right", u = "Bottom", c.style.left = a.x - o.link_line_width / 2 + "px", c.style.top = a.y - s + "px") : a.direction.from === "up" && a.direction.to === "right" ? (d = "Left", u = "Top", c.style.left = a.x - o.link_line_width / 2 + "px", c.style.top = a.y - s + "px") : a.direction.from === "left" && a.direction.to === "down" ? (d = "Left", u = "Top", c.style.left = a.x - s - o.link_line_width / 2 + "px", c.style.top = "".concat(a.y, "px")) : a.direction.from === "down" && a.direction.to === "left" ? (d = "Right", u = "Bottom", c.style.left = a.x - s - o.link_line_width / 2 + "px", c.style.top = "".concat(a.y, "px")) : a.direction.from === "left" && a.direction.to === "up" ? (d = "Left", u = "Bottom", c.style.left = a.x - s - o.link_line_width / 2 + "px", c.style.top = a.y - s + "px") : a.direction.from === "up" && a.direction.to === "left" && (d = "Right", u = "Top", c.style.left = a.x - s - o.link_line_width / 2 + "px", c.style.top = a.y - s + "px"), c.style["border".concat(u, "Width")] = "".concat(l, "px"), c.style["border".concat(d, "Width")] = "".concat(l, "px"), c.style["border".concat(d, "Style")] = "solid", c.style["border".concat(u, "Style")] = "solid", c.style["border".concat(u).concat(d, "Radius")] = "".concat(s, "px"), c;
        },
        render_arrow (a, r) {
            var s = document.createElement("div"), o = a.y, l = a.x, c = r.link_arrow_size;
            s.style.setProperty("--dhx-gantt-icon-size", "".concat(c, "px"));
        ...
        _get_line: function(a, r) {
            var s = this.get_direction(a, r), o = {
                x: a.x,
                y: a.y,
    ...
    init: function(t, e) {
        ...
        if (e.$config.bind && t.getDatastore(e.$config.bind)) {
            ...
            t.defined(e.$getConfig().dnd_sensitivity) && (i.config.sensitivity = e.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
                ...
                if (s(d)) return !1;
                var u = r().getItem(d);
                return !t.isReadonly(u) && (i.config.initial_open_state = u.$open, !!t.callEvent("onRowDragStart", [
                    d,
                ...
                l.$transparent = !1, l.$open = i.config.initial_open_state, this.callEvent("onBeforeRowDragEnd", [
                    i.config.id,
                    i.config.parent,
                    i.config.index
                ]) === !1 ? (o.move(i.config.id, i.config.index, i.config.parent), l.$drop_target = null) : this.callEvent("onRowDragEnd", [
                    i.config.id,
                    l.$drop_target
                ]), t.render(), this.refreshData();
            }, t));
        }
        function a(o) {
...
const Ke = {
    ...
    highlightPosition: function(t, e, n) {
        ...
        a || ((a = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", a.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", a.style.pointerEvents = "none"), t.child ? function(r, s, o) {
            var l = r.targetParent, c = Je({
                x: 0,
                y: o.getItemTop(l)
            }, o), d = o.$grid_data.getBoundingClientRect().bottom + window.scrollY;
            ...
            var l = function(u, h) {
                var _ = h.$config.rowStore, p = {
                    x: 0,
                    y: 0
                }, y = h.$grid_data.querySelector(".gantt_tree_indent"), k = 15, b = 0;
                y && (k = y.offsetWidth);
                var g = 40;
    ...
    init: function(t, e) {
        ...
        if (e.$config.bind && t.getDatastore(e.$config.bind)) {
            ...
            t.defined(e.$getConfig().dnd_sensitivity) && (i.config.sensitivity = e.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
                ...
                return !t.isReadonly(u) && !r(d) && (i.config.initial_open_state = u.$open, !!t.callEvent("onRowDragStart", [
                    d,
                    l.target || l.srcElement,
                    l
                ]) && void 0);
                ...
                var c = s(l);
                return c && t.callEvent("onBeforeRowDragMove", [
                    i.config.id,
                    c.targetParent,
                    c.targetIndex
                ]) !== !1 || (c = K.createDropTargetObject(i.config.drop_target)), Ke.highlightPosition(c, i.config, e), i.config.drop_target = c, t._waiAria.reorderMarkerAttr(i.config.marker), this.callEvent("onRowDragMove", [
                    i.config.id,
                    c.targetParent,
                    c.targetIndex
                ]), !0;
                ...
                this.callEvent("onBeforeRowDragEnd", [
                    ...
                    c.targetParent,
                    c.targetIndex
                ]) === !1 ? l.$drop_target = null : (o.move(i.config.id, c.targetIndex, c.targetParent), t.render(), this.callEvent("onRowDragEnd", [
                    i.config.id,
                    c.targetParent,
                    c.targetIndex
                ])), o.refresh(l.id);
    ...
    return {
        ...
        initEvents: function(e, n) {
            this._mouseDelegates.delegate("click", "gantt_row", n.bind(function(i, a, r) {
                ...
                if (n.callEvent("onGridHeaderClick", [
                    s,
                    i
                ])) {
                    var o = e.$getConfig();
                    ...
                    } else n.$services.getService("mouseEvents").callHandler("click", "gantt_add", e.$grid, [
                        i,
                        o.root_id
                    ]);
                }
                ...
                return t = function(i, a) {
                    ...
                    return {
                        ...
                        _update_item_on_move: function(s, o, l, c, d, u) {
                            ...
                            this._handlers[l].apply(this, [
                                p,
                                s,
                                c,
                                u
                            ]), a.mixin(h, p, !0), a.callEvent("onTaskDrag", [
                                h.id,
                                l,
                                p,
                                _,
                                d
                            ]), a.mixin(h, p, !0), a.refreshTask(o);
                        },
                        ...
                        on_mouse_down: function(s, o) {
                            if (s.button != 2 || s.button === void 0) {
                                ...
                                if (a.isTaskExists(c) && (d = a.getTask(c)), !a.isReadonly(d) && !this.drag.mode) {
                                    ...
                                    else if (a.checkEvent("onMouseDown") && a.callEvent("onMouseDown", [
                                        u.split(" ")[0]
                                    ]) && o.parentNode) return this.on_mouse_down(s, o.parentNode);
                                }
                            }
                        },
                        ...
                        _finalize_mouse_up: function(s, o, l, c) {
                            var d = a.getTask(s);
                            if (o.work_time && o.correct_work_time && this._fix_working_times(d, l), this._fix_dnd_scale_time(d, l), this._fireEvent("before_finish", l.mode, [
                                s,
                                l.mode,
                                a.copy(l.obj),
                                c
                                ...
                                var u = s;
                                a._init_task_timing(d), this.clear_drag_state(), a.updateTask(d.id), this._fireEvent("after_finish", l.mode, [
                                    u,
                                    l.mode,
                                    c
                                ]);
                        ...
                        _start_dnd: function(s) {
                            ...
                            if (l["drag_" + o.mode] && a.callEvent("onBeforeDrag", [
                                c,
                                o.mode,
                                s
...
var Oa = function(t, e) {
    ...
    var u = "gantt_link_point", h = "gantt_link_control", _ = new d(t.$task_bars, {
        sensitivity: 0,
        updates_per_second: 60,
    ...
    function p(m, f) {
        ...
        }, S = e.config.tooltip_offset_x || 10, T = e.config.tooltip_offset_y || 10, E = e.config.scroll_size || 18, C = e.$container.getBoundingClientRect().y + window.scrollY, D = {
            y: x.y + T,
            x: x.x + S,
    ...
    function b(m, f, v, x) {
        ...
        if (T = Math.max(0, T - 3)) {
            ...
            var D = Math.sin(C), M = Math.cos(C), I = Math.round(f), A = Math.round(m), N = [
    ...
    _.attachEvent("onBeforeDragStart", e.bind(function(m, f) {
        ...
        if (Y(yt(f), e.$root) || ($ = !1, E = null), $ && (C = !pt(f, "task_end_date"), $ = !!E), i = E, n = $, a = C, $) {
            const M = pt(f, h).querySelector(".".concat(u));
            if (M) {
        ...
        if (m.link_source_id && m.link_target_id && m.link_source_id != m.link_target_id) {
            var f = e._get_link_type(m.link_from_start, m.link_to_start), v = {
                source: m.link_source_id,
                target: m.link_target_id,
                type: f
            };
            v.type && e.isLinkAllowed(v) && e.callEvent("onLinkCreated", [
                v
            ]) && e.addLink(v);
        }
...
var za = function(t) {
    ...
    return {
        ...
        _attachDomEvents: function(n) {
            function i(a, r) {
                if (a && this.callEvent("onLinkDblClick", [
                    a,
                    r
                ])) {
        ...
        onInitialized: function(e) {
            ...
            if (i.resizer) {
                ...
                s.attachEvent("onResizeStart", function(o, l) {
                    ...
                    return a = r ? o : l, t.callEvent("onGridResizeStart", [
                        a
                    ]);
                }), s.attachEvent("onResize", function(o, l) {
                    var c = r ? o : l;
                    return t.callEvent("onGridResize", [
                        a,
                        c
                    ]);
                    ...
                    var y = t.callEvent("onGridResizeEnd", [
                        u,
                        h
                    ]);
                        ...
                        return {
                            ...
                            onrender: function(s, o, l) {
                                for(var c = l.getGridColumns(), d = 0; d < c.length; d++){
                                    var u = c[d];
                                    if (u.onrender) {
                                        var h = o.querySelector('[data-column-name="'.concat(u.name, '"]'));
                                        if (h) {
                ...
                taskRollupBar: function() {
                    return function(r) {
                        ...
                        function c(u, h, _, p) {
                            ...
                            if (y.$rendered_at = u.id, r.callEvent("onBeforeRollupTaskDisplay", [
                                y.id,
                                y,
                                u.id
                            ]) === !1) return;
                    ...
                    return function(r) {
                        ...
                        function l(d, u, h, _, p) {
                            ...
                            if (y || k) {
                                ...
                                return m.setAttribute(p.$config.item_attribute, d.id), m.className = [
                                    "gantt_resource_marker",
                                    y
                                ].join(" "), m.style.cssText = [
                                    "left:" + g.left + "px",
                                    "width:" + g.width + "px",
                                    "height:" + b + "px",
                                    "line-height:" + b + "px",
                                    "top:" + g.top + "px"
                                ].join(";"), k && (m.innerHTML = k), m;
                            }
                            return null;
                        }
                        function c(d, u) {
...
class qa {
    ...
    constructor(e){
        this.zoomIn = ()=>{
            ...
            if (delete s.name, a.mixin(a.config, s, !0), [
                "resourceTimeline",
                "resourceHistogram"
            ].forEach(function(o) {
            ...
            a = typeof n.element == "function" ? n.element() : n.element, a && this._domEvents.attach(a, i, this.$gantt.bind(function(r) {
                ...
                if (typeof this._handler == "function") return this._handler.apply(this, [
                    r
                ]), !0;
            }, this), {
                passive: !1
...
function Ga(t) {
    function e() {
        if (t.config.touch != "force" && (t.config.touch = t.config.touch && (navigator.userAgent.indexOf("Mobile") != -1 || navigator.userAgent.indexOf("iPad") != -1 || navigator.userAgent.indexOf("Android") != -1 || navigator.userAgent.indexOf("Touch") != -1) || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1), t.config.touch) {
            ...
            }) : window.navigator.pointerEnabled ? t._touch_events([
                "pointermove",
                "pointerdown",
                "pointerup"
            ], function(s) {
            ...
            }) : window.navigator.msPointerEnabled && t._touch_events([
                "MSPointerMove",
                "MSPointerDown",
                "MSPointerUp"
            ], function(s) {
    ...
    function n(r) {
        var s = r.$config.scrollX ? t.$ui.getView(r.$config.scrollX) : null, o = r.$config.scrollY ? t.$ui.getView(r.$config.scrollY) : null, l = {
            x: null,
            y: null
        };
                            ...
                            if (S) {
                                ...
                                if (T) {
                                    ...
                                    for(let C = 0; C < w.length; C++){
                                        ...
                                        let M;
                                        if (D && D.childNodes && (M = D.querySelector("[".concat(t.config.task_attribute, '="').concat(S.id, '"]'))), M) {
...
function qt(t) {
    ...
    return z(n, e), n.prototype.render = function(i) {
        const a = i.height ? "height:".concat(i.height, "px;") : "";
        let r = "<div class='gantt_cal_ltext gantt_section_".concat(i.name, "' ").concat(a ? "style='".concat(a, "'") : "", ">");
...
function Ya(t) {
    ...
    return z(n, e), n.prototype.render = function(a) {
        ...
        return a.onselect = null, a.parentNode.replaceChild(c, a), t.form_blocks.select.set_value.apply(t, [
            c,
            r,
            s,
            o
...
function Ja(t) {
    var e = function() {
        ...
        return z(m, g), m.prototype.render = function(f) {
            let v = f.height ? "".concat(f.height, "px") : "";
            return "<div class='gantt_cal_ltext gantt_cal_template gantt_section_".concat(f.name, "' ").concat(v ? "style='height:".concat(v, ";'") : "", "></div>");
        ...
        return z(f, m), f.prototype.render = function(v) {
            const x = (v.height || "130") + "px", $ = v.placeholder ? "placeholder='".concat(v.placeholder, "'") : "";
            return "<div class='gantt_cal_ltext gantt_section_".concat(v.name, "' style='height:").concat(x, ";' ").concat($, "><textarea></textarea></div>");
        ...
        return z(f, m), f.prototype.render = function(v) {
            ...
            var I = $[M.start_date] || /* @__PURE__ */ new Date(), A = $[M.end_date] || g.calculateEndDate({
                start_date: I,
                duration: 1,
                task: $
            });
        ...
        return z(f, m), f.prototype.render = function(v) {
            const x = v.height ? "height:".concat(v.height, "px;") : "";
            let $ = "<div class='gantt_cal_ltext gantt_cal_lcheckbox gantt_section_".concat(v.name, "' ").concat(x ? "style='".concat(x, "'") : "", ">");
        ...
        return z(f, m), f.prototype.render = function(v) {
            const x = v.height ? "".concat(v.height, "px") : "";
            let $ = "<div class='gantt_cal_ltext gantt_cal_lradio gantt_section_".concat(v.name, "' ").concat(x ? "style='height:".concat(x, ";'") : "", ">");
        ...
        return z(f, m), f.prototype.render = function(w) {
            ...
            var C, D, M, I, A = w.getElementsByTagName("select"), N = w.getElementsByTagName("input"), L = N[1], O = [
                N[0],
                N[2]
            ], G = w.getElementsByTagName("span")[0], j = E._time_format_order;
            function H() {
                var J = x.call(g, w, E), B = $.call(g, w, E), _t = g.calculateEndDate({
                    start_date: J,
                    duration: B,
                    task: T
            ...
            var E = x(w, T), C = $(w, T), D = g.calculateEndDate({
                start_date: E,
                duration: C,
                task: S
            });
        ...
        return z(f, m), f.prototype.render = function($) {
            const w = $.height ? "height:".concat($.height, "px;") : "";
            let S = "<div class='gantt_cal_ltext gantt_section_".concat($.name, "' ").concat(w ? "style='".concat(w, "'") : "", ">");
            var T = [];
        ...
        function x(S, T, E, C) {
            ...
            const G = "<div class='gantt_duration' " + I + "><div class='gantt_duration_inputs'><input type='button' class='gantt_duration_dec' value='−'" + A + "><input type='text' value='5days' class='" + O + "'" + A + " " + N + "><input type='button' class='gantt_duration_inc' value='+'" + A + "></div><div class='gantt_duration_end_date'>" + M + "<span></span></div></div></div>", j = "<div><div class='baseline_delete_button gantt_custom_button'>".concat(L, "</div></div>"), H = document.createElement("div");
            ...
            var tt, J, B, _t = H.getElementsByTagName("select"), Tt = H.getElementsByTagName("input"), Et = Tt[1], Ee = [
                Tt[0],
                Tt[2]
            ], Sn = H.getElementsByTagName("span")[0], Tn = C._time_format_order;
            function gt() {
                var ct = $.call(g, H, C), U = w.call(g, H, C), En = g.calculateEndDate({
                    start_date: ct,
                    duration: U,
                    task: E
        ...
        return z(f, m), f.prototype.render = function(S) {
            return "<div style='height: ".concat(S.height || 100, "px; padding-top:0px; font-size:inherit;' class='gantt_section_baselines'></div>");
            ...
            if (g.callEvent("onSectionButton", [
                g._lightbox_id,
                E
            ]) !== !1 && (T.closest(".gantt_custom_button.gantt_remove_baselines") && (C.innerHTML = g.locale.labels.baselines_section_placeholder), T.closest(".gantt_custom_button.gantt_add_baselines"))) {
    ...
    t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t._lightbox_template = "<div class='gantt_cal_ltitle'><div class=\"dhx_cal_ltitle_descr\"><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='dhx_title'></span>\n</div>\n<div class=\"gantt_cal_ltitle_controls\">\n	<a class=\"gantt_cal_ltitle_close_btn dhx_gantt_icon dhx_gantt_icon_close\"></a>\n\n</div></div><div class='gantt_cal_larea'></div>", t._lightbox_root = t.$root, t.$services.getService("state").registerProvider("lightbox", function() {
        ...
        if (this.callEvent("onBeforeLightbox", [
            ...
            this.showCover(f), this._fill_lightbox(g, f), this._setLbPosition(f), this._waiAria.lightboxVisibleAttr(f), this.callEvent("onLightbox", [
                g
            ]);
    ...
    function k(g) {
        var m, f;
        return g.time_format ? g.time_format : (f = [
            "%d",
            "%m",
            "%Y"
        ], Vt((m = t.getScale()) ? m.unit : t.config.duration_unit) < Vt("day") && f.push("%H:%i"), f);
    }
    function b(g, m, f) {
        var v, x, $, w, S, T, E = "";
    ...
    t._init_lightbox_events = function() {
        t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function() {
            ...
            t._lightbox_current_type = null, t.callEvent("onLightboxDelete", [
                t._lightbox_id
            ]) && (t.isTaskExists(t._lightbox_id) ? t.$click.buttons.delete(t._lightbox_id) : t.hideLightbox());
        }, t.lightbox_events.gantt_cancel_btn = function() {
            t._cancel_lightbox();
        }, t.lightbox_events.default = function(g, m) {
            if (m.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [
                m.className,
                m,
                g
            ]);
        ...
        t._lightbox_current_type = null, this.callEvent("onLightboxCancel", [
            this._lightbox_id,
            g.$new
        ...
        var g = this.getLightboxValues();
        t._lightbox_current_type = null, this.callEvent("onLightboxSave", [
            this._lightbox_id,
            g,
            !!g.$new
        ]) && (t.$data.tasksStore._skipTaskRecalculation = "lightbox", g.$new ? (delete g.$new, this.addTask(g, g.parent, this.getTaskIndex(g.id))) : this.isTaskExists(g.id) && (this.mixin(this.getTask(g.id), g, !0), this.refreshTask(g.id), this.updateTask(g.id)), t.$data.tasksStore._skipTaskRecalculation = !1, this.refreshData(), this.hideLightbox());
        ...
        const m = [
            ...this._get_typed_lightbox_config()
        ].sort((f, v)=>f.name === "time" ? 1 : v.name === "time" ? -1 : 0);
        ...
        var x = t._lightbox_root.querySelector("#" + v.id), $ = x.nextSibling, w = {
            section: v,
            header: x,
            node: $,
            getValue: function(T) {
        ...
        return !1;
    }, t._delete_task_confirm = function(param) {
        let { task: g, message: m, title: f, callback: v, ok: x } = param;
        t._simple_confirm(m, f, v, x);
    }, t._delete_link_confirm = function(param) {
        let { link: g, message: m, title: f, callback: v, ok: x } = param;
        t._simple_confirm(m, f, v, x);
        ...
        t.$ui = n.factory, t.$ui.layers = n.render, t.$mouseEvents = n.mouseEvents, t.$services.setService("mouseEvents", function() {
            ...
            return {
                getColumnIndex: function(u) {
                    var h = d.call(this, a, "getColumnIndex", [
                        u
                    ]);
                    return h === c ? 0 : h;
                },
                ...
                posFromDate: function(u) {
                    var h = d.call(this, i, "posFromDate", [
                        u
                    ]);
                    return h === c ? 0 : h;
                },
                getRowTop: function(u) {
                    var h = this, _ = d.call(h, i, "getRowTop", [
                        u
                    ], function() {
                        return d.call(h, a, "getRowTop", [
                            u
                        ]);
                    });
                    return _ === c ? 0 : _;
                ...
                getTaskTop: function(u) {
                    var h = this, _ = d.call(h, i, "getItemTop", [
                        u
                    ], function() {
                        return d.call(h, a, "getItemTop", [
                            u
                        ]);
                    });
                    return _ === c ? 0 : _;
                ...
                getTaskPosition: function(u, h, _) {
                    var p = d.call(this, i, "getItemPosition", [
                        u,
                        h,
                        _
                    ]);
                ...
                getTaskBarHeight: function(u, h) {
                    var _ = this, p = d.call(_, i, "getBarHeight", [
                        u,
                        h
                    ], function() {
                        return d.call(_, a, "getItemHeight", [
                            u
                        ]);
                    });
                    return p === c ? 0 : p;
                ...
                getTaskHeight: function(u) {
                    var h = this, _ = d.call(h, i, "getItemHeight", [
                        u
                    ], function() {
                        return d.call(h, a, "getItemHeight", [
                            u
                        ]);
                    });
                    return _ === c ? 0 : _;
                ...
                columnIndexByDate: function(u) {
                    var h = d.call(this, i, "columnIndexByDate", [
                        u
                    ]);
                    return h === c ? 0 : h;
                },
                ...
                scrollTo: function(u, h) {
                    ...
                    _ && (w = _.getScrollState()), p && (S = p.getScrollState()), this.callEvent("onGanttScroll", [
                        y.position,
                        k.position,
                        S.position,
                        w.position
            ...
            i._extend_to_optional = function(a) {
                var r = a, s = {
                    ...
                    update_block: function(o, l) {
                        if (i.callEvent("onSectionToggle", [
                            i._lightbox_id,
                            l
                        ]), o.style.display = l.disabled ? "none" : "", l.button) {
                    ...
                    button_click: function(o, l, c, d) {
                        if (i.callEvent("onSectionButton", [
                            i._lightbox_id,
                            c
                        ]) !== !1) {
            ...
            for(var c in i._waiAria = {
                ...
                gridAttrString: function() {
                    return [
                        " role='treegrid'",
                        i.config.multiselect ? "aria-multiselectable='true'" : "aria-multiselectable='false'",
                        " "
                    ].join(" ");
                },
...
const Xa = Z.gantt = function(t) {
    ...
    return e.env.isNode || (Ka(e), function(n) {
        n.load = function(i, a, r) {
            ...
            var s = "json", o = null;
            return arguments.length >= 3 ? (s = a, o = r) : typeof arguments[1] == "string" ? s = arguments[1] : typeof arguments[1] == "function" && (o = arguments[1]), this._load_type = s, this.callEvent("onLoadStart", [
                i,
                s
            ]), this.ajax.get(i, n.bind(function(l) {
                this.on_load(l, s), this.callEvent("onLoadEnd", [
                    i,
                    s
...
//# sourceMappingURL=node_modules_dhtmlx-gantt_codebase_dhtmlxgantt_es_b8b5681c.js.map